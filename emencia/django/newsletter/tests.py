...
class MailerTestCase(TestCase):
    ...
    def test_expedition_list(self):
        ...
        self.assertEqual(len(mailer.get_expedition_list()), 2)
        self.server.mails_hour = 1
        self.assertEqual(len(mailer.get_expedition_list()), 1)

        self.server.mails_hour = 100
        mailer = Mailer(self.newsletter)
        self.assertEqual(len(mailer.get_expedition_list()), 4)
        self.server.mails_hour = 3
        self.assertEqual(len(mailer.get_expedition_list()), 3)
